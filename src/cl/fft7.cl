...
void fft7(T2 *u) {
  ...
  const double
      ...
      C2=0.79015646852540022,
      C3=0.055854267289647735,
      C4=0.73430220123575241,
      S1=0.44095855184409843,
      S2=0.34087293062393137,
      S3=-0.53396936033772513,
      S4=0.87484229096165655;
  ...
  T2 m6 = -S2 * mul_t4(u[4] + u[6]);
  T2 t14 = u[6] - u[5];
  T2 s3 = fmaT2(S4, mul_t4(t14), m6);

  X2(u[5], u[4]);
  u[4] = S1 * mul_t4(u[4] + u[6]);
  u[6] = fmaT2(S3, mul_t4(u[5]), m6);
