...
struct FFTConfig {
  ...
  //
  // On 2020-04-08 we implemented options to minimize multiply chain lengths in MiddleMul kernels.
  // This allows more bits-per-FFT-word.  I also gathered roundoff data for each MIDDLE length.
  static u32 getMaxExp(u32 fftSize, u32 middle) { return
                ...
                middle == 4 ? fftSize * (18.895 - 0.279 * log2(fftSize / (2 * 1024 * 1024))) :
                middle == 5 ? fftSize * (18.817 - 0.279 * log2(fftSize / (2.5 * 1024 * 1024))) :
                middle == 6 ? fftSize * (18.704 - 0.279 * log2(fftSize / (3.0 * 1024 * 1024))) :
                middle == 7 ? fftSize * (18.659 - 0.279 * log2(fftSize / (3.5 * 1024 * 1024))) :
                middle == 8 ? fftSize * (18.630 - 0.279 * log2(fftSize / (4.0 * 1024 * 1024))) :
                middle == 9 ? fftSize * (18.463 - 0.279 * log2(fftSize / (4.5 * 1024 * 1024))) :
                middle == 10 ? fftSize * (18.544 - 0.279 * log2(fftSize / (5.0 * 1024 * 1024))) :
                middle == 11 ? fftSize * (18.474 - 0.279 * log2(fftSize / (5.5 * 1024 * 1024))) :
			       fftSize * (18.376 - 0.279 * log2(fftSize / (6.0 * 1024 * 1024))); }
